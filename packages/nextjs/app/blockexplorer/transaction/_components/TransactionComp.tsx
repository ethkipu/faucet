...
const TransactionComp = ({ txHash }: { txHash: Hash }) => {
  ...
  return (
    <div className="container px-10 mx-auto mt-10 mb-20 md:px-0">
      <button className="btn btn-sm btn-primary" onClick={() => router.back()}>
        Back
      </button>
      {transaction ? (
        <div className="overflow-x-auto">
          <h2 className="mb-4 text-3xl font-bold text-center text-primary-content">Transaction Details</h2>{" "}
          <table className="table w-full rounded-lg shadow-lg bg-base-100 md:table-lg table-md">
            <tbody>
              <tr>
                <td>
                  ...
                  <div className="w-full md:max-w-[600px] lg:max-w-[800px] overflow-x-auto whitespace-nowrap">
                    {functionCalled === "0x" ? (
                      ...
                      <>
                        ...
                        <span className="font-bold badge badge-primary">{functionCalled}</span>
                      </>
                    )}
                  </div>
                </td>
