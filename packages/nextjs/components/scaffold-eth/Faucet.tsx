...
export const Faucet = () => {
  ...
  return (
    <div>
      <label htmlFor="faucet-modal" className="gap-1 font-normal btn btn-primary btn-sm">
      ...
      <label htmlFor="faucet-modal" className="cursor-pointer modal">
        <label className="relative modal-box">
          ...
          <input name="dummyInput" id="dummyInput" className="absolute top-0 left-0 w-0 h-0" />
